#!/usr/bin/env python
# Adapted from osxrelocator, https://github.com/GStreamer/cerbero/blob/master/cerbero/tools/osxrelocator.py
# Part of cerbero - a multi-platform build system for Open Source software

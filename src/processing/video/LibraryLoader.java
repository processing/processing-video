...
public class LibraryLoader {
  ...
  static final Object[][] LINUX_DEPENDENCIES = {
    ...
    // Note that the order of the libraries in this list IS improtant,
    // some libraries will not load if a dependency is not loaded before.
    // { "libxml2.so", new String[] {}, false },
    // { "libavutil.so.56", new String[] {}, false },
    // { "libswresample.so.3", new String[] {}, false },
    // { "libswscale.so.5", new String[] {}, false },
    // { "libavcodec.so.58", new String[] {}, false },
    // { "libavformat.so.58", new String[] {}, false },
    // { "libavresample.so.4", new String[] {}, false },
    // { "libavfilter.so.7", new String[] {}, false },
    // { "libavdevice.so.58", new String[] {}, false },
    // { "libavtp.so.0.1.0", new String[] {}, false },
    // { "libcairo-gobject.so.2.11705.0", new String[] {}, false },
    // { "libcairo-script-interpreter.so.2.11705.0", new String[] {}, false },
    // { "libcairo.so.2.11705.0", new String[] {}, false },
    // { "libdv.so.4.0.3", new String[] {}, false },
    // { "libfdk_aac.so", new String[] {}, false },
    // { "libfontconfig.so.1.12.0", new String[] {}, false },
    // { "libfreetype.so.6.18.0", new String[] {}, false },
    // { "libfribidi.so.0.4.0", new String[] {}, false },
    // { "libgio-2.0.so.0.7000.5", new String[] {}, false },
    // { "libglib-2.0.so.0.7000.5", new String[] {}, false },
    // { "libgmodule-2.0.so.0.7000.5", new String[] {}, false },
    // { "libgobject-2.0.so.0.7000.5", new String[] {}, false },
    // { "libgstbase-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstreamer-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstallocators-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstapp-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstaudio-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstbadaudio-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstbasecamerabinsrc-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstcheck-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstcodecparsers-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstcodecs-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstcontroller-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstfft-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstinsertbin-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstisoff-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstmpegts-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstnet-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstpbutils-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstphotography-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstplay-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstplayer-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstriff-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstrtp-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstrtsp-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstrtspserver-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstsctp-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstsdp-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgsttag-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgsttranscoder-1.0.so.0", new String[] {}, false },
    // { "libgsturidownloader-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstvalidate-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstvalidate-default-overrides-1.0.so.0.2003.0", new String[] {}, false },
    // { "libges-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstadaptivedemux-1.0.so.0.2003.0", new String[] {}, false },    
    // { "libgstvideo-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgstwebrtc-1.0.so.0.2003.0", new String[] {}, false },
    // { "libgthread-2.0.so.0.7000.5", new String[] {}, false },
    // { "libharfbuzz-gobject.so.0.20802.0", new String[] {}, false },
    // { "libharfbuzz.so.0.20802.0", new String[] {}, false },
    // { "libharfbuzz-subset.so.0.20802.0", new String[] {}, false },
    // { "libjpeg.so.8.2.2", new String[] {}, false },
    // { "libjson-glib-1.0.so.0.600.6", new String[] {}, false },
    // { "libmicrodns.so.0.1.0", new String[] {}, false },
    // { "libmp3lame.so.0.0.0", new String[] {}, false },
    // { "libnice.so.10.12.0", new String[] {}, false },
    // { "libogg.so.0.8.5", new String[] {}, false },
    // { "libopenh264.so.2.1.1", new String[] {}, false },
    // { "libopenjp2.so.2.3.1", new String[] {}, false },
    // { "libopus.so.0.8.0", new String[] {}, false },
    // { "liborc-0.4.so.0.32.0", new String[] {}, false },
    // { "liborc-test-0.4.so.0.32.0", new String[] {}, false },
    // { "libpango-1.0.so.0.4800.11", new String[] {}, false },
    // { "libpangocairo-1.0.so.0.4800.11", new String[] {}, false },
    // { "libpangoft2-1.0.so.0.4800.11", new String[] {}, false },
    // { "libpixman-1.so.0.40.1", new String[] {}, false },
    // { "libpng16.so.16.37.0", new String[] {}, false },
    // { "libpostproc.so.55", new String[] {}, false },
    // { "libpsl.so.5.3.2", new String[] {}, false },
    // { "libsoup-2.4.so.1.11.1", new String[] {}, false },
    // { "libsoup-gnome-2.4.so.1.11.1", new String[] {}, false },
    // { "libsqlite3.so.0.8.6", new String[] {}, false },
    // { "libvorbisenc.so.2.0.12", new String[] {}, false },
    // { "libvorbisfile.so.3.3.8", new String[] {}, false },
    // { "libvorbis.so.0.4.9", new String[] {}, false }
};
